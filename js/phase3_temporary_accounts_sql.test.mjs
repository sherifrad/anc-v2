...
for (const fragment of [
  ...
  "'mfa_required'",
  "'delegated.invalid_request'",
  'phase3_record_action_result',
  "'A matching authorized action was not found'",
  "'The action result was already recorded'",
...
console.log(JSON.stringify({
  ...
  checks: [
    ...
    'invalid delegated requests are recorded instead of disappearing',
    'authorized actions require a correlated immutable result event',
    'first-login completion is service-role-only and keeps access disabled',
