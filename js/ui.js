...
const UI = (() => {
  ...
  function scanRowHTML(scan={}, idx, lmpDate) {
    ...
    <tr data-idx="${idx}" class="scan-row">
      ...
      <td colspan="4">
        <div style="padding:6px 8px">
          <textarea class="scan-findings" placeholder="General findings / impression..." style="margin-bottom:6px;min-height:40px">${scan.findings||''}</textarea>
          <div class="us-subfields">
    ...
    <tr class="scan-attachment-row" data-parent="${idx}">
      <td colspan="9" style="padding:0 8px 10px 12px">
