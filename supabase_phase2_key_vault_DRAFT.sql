-- PHASE 2A REVIEW DRAFT - DO NOT RUN
--
-- Proposed owner-only, MFA-protected storage for wrapped Clinic Data Keys.
-- This script is intentionally not referenced or applied by the application.

do $phase2_draft_guard$
begin
...
drop trigger if exists set_clinic_key_vault_updated_at on public.clinic_key_vault;
